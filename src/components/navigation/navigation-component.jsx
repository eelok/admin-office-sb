    ...
    return (
        <nav className='navbar'>
            ...
            <div id='side-menu' className={`side-nav ${isMenuOpen ? 'side-nav--open' : ''}`}>
                ...
                <Link className='side-nav__link' to='/' onClick={closeSlideMenu}>Concerts</Link>
                <Link className='side-nav__link' to='/addconcert' onClick={closeSlideMenu}>Add Concert</Link>
            </div>
        </nav>
    )
}
